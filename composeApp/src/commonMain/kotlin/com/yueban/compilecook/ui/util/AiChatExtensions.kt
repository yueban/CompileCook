...
val AiChatContext.displayName: String
  ...
  get() = when (this) {
    ...
    is AiChatContext.DishCategory -> category.displayName ?: stringResource(Res.string.dish_list_title)
    is AiChatContext.DishDifficulty -> stringResource(Res.string.dish_list_difficulty_title_format, level)
